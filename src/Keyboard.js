        ...
        <div key={idx} className="w-full flex justify-center my-[5px]">
          {idx === 2 && (
            <button
              ...
              className="h-10 xxs:h-14 w-12 px-1 text-xs mx-[3.5px] rounded nm-flat-background-sm dark:nm-flat-background-dark-sm text-primary dark:text-primary-dark"
            >
              ENTER
            </button>
          )}
          {row.map((letter) => (
            <button
              ...
              key={letter}
              className="h-10 xxs:h-14 w-[2rem] sm:w-10 mx-[3.5px] text-sm rounded-[4px] nm-flat-background-sm dark:nm-flat-background-dark-sm"
            >
              <div
